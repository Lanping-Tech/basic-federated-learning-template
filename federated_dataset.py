...
"""Library for loading and preprocessing ?? training and testing data."""
...
def load_federated_dataset(
  ...
  """Construct a federated dataset from the centralized ??
  ...
  #TODO Load the data set in numpy format

  train_images, train_labels = (None,None) # tfds.as_numpy()
  test_images, test_labels = (None,None) # tfds.as_numpy()
...
def get_federated_datasets(train_client_batch_size: int = 20,
  ...
  cifar_train, cifar_test = load_federated_dataset()
